...
4. **Metadata flags:** missing EXIF entirely (common for screenshots and downloads) → `NO_EXIF`; image dimensions matching a phone screen aspect + no camera make/model → `SCREENSHOT_SUSPECTED`.
